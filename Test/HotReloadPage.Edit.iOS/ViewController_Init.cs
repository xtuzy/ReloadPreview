...
namespace HotReloadPage.Edit.iOS
{
    public partial  class ViewController_Init:IReload
    {
        ...
        public void Reload(object controller,object view)
        {
            ...
            Page.BackgroundColor = UIColor.SystemYellowColor;
            ...
            button.SetTitle("OKHkkjjdfsssssadfsfj", UIControlState.Normal);
        ...
        private void SkiaView_PaintSurface(object sender, SkiaSharp.Views.iOS.SKPaintSurfaceEventArgs e)
        {
            var h = e.Info.Height;
            var w = e.Info.Width;
            e.Surface.Canvas.DrawRect(new SKRect(0, 0, w, h), new SKPaint() { Color = SKColors.Cyan});
        }
