        ...
        internal static void BuildAndSendDll()
        {
            ...
            try
            {
                ...
                if (Target.Contains("-windows"))
                {
                    ...
                    StartMSBuild(CsprojRootFolder, $"dotnet build {CsprojFileFullPath} /p:OutputType=Library /p:WarningLevel=0 /p:DebugType=None  /p:TargetFrameworks=\"{Target}\" /p:OutDir={tempOutputFolder}  /p:GenerateDependencyFile=false");
